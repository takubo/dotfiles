...
syn match   awkRegExp	contained "[^\\]\zs[?.*{}|+()]" "lc=1,hs=s+2
"syn match   awkRegExp	contained "[^\\]\zs[?.*{}|+()]" "me=e-1,he=e+1 "ms=s-1,hs=s,ms=s-1
"syn match   awkRegExp	contained "\%(R\)\@![?.*{}|+()]" "ms=s-1,hs=s,ms=s-1
"syn match   awkRegExp	contained "[^\\][?.*{}|+()]""hs=s,ms=s-1
"syn match   awkRegExp	contained "\\[a-wyzA-WYZ/\\\"][?.*{}|+()]"ms=s-2

" String and Character constants
" Highlight special characters (those which have a backslash) differently
syn region  awkString	start=+"+  skip=+\\\\\|\\"+  end=+"+  contains=@Spell,awkSpecialCharacter,awkSpecialPrintf
syn match   awkSpecialCharacter contained "\\[a-wyzA-WYZ/\\\"]"" takubo he=s+1,me=e-1
...
syn match  awkNumber		display "[+-]\=\<0x[0-9a-fA-F]\+\>"
